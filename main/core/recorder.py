...
#  重構：匯入新模組
try:
    from utils.bezier_mouse import BezierMouseMover
...
try:
    from vision.yolo_detector import YOLODetector, get_detector, YOLO_AVAILABLE
except ImportError:
...
#  v2.9.0: 匯入強化圖片辨識模組
try:
    from vision.image_matcher import get_matcher, HybridMatcher
