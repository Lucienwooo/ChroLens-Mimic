...
from editor.editor_parser import EditorParserMixin
from editor.editor_flowchart import EditorFlowchartMixin
class TextCommandEditor(EditorParserMixin, EditorFlowchartMixin, tk.Toplevel):
    ...
    def _create_command_buttons_in_frame(self, parent_frame):
        ...
        self.button_categories = {
            "圖片辨識": [
                ...
                ("等待圖片", "#1976D2", None, ">等待圖片>pic01, T=1s500"),
    ...
    def _insert_command_template(self, template):
        """插入指令模板並套用內容感知 (v2.8)"""
        try:
            from modules.command_lang import translate_ui_string
    ...
    def _translate_script_to_lang(self, lang):
        try:
            from modules.command_lang import translate_ui_string, translate_script_line_to_canonical
